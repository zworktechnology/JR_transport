...
<body>
  <div class="page-wrapper">
    ...
    <header id="home" class="main-header header-style-two">
      ...
      <div class="header-top">
        <div class="top-left">
          ...
          <ul class="list-style-one">
            <li>
              <i class="fa fa-map-marker-alt"></i><a href="javascript:void(0)" style="color: black">
                VIP Nagar, Thiru Nagar, Tiruchirappalli - 620 004.</a>
            </li>
            <li>
            ...
            <li>
              <i class="fa fa-phone-square"></i><a href="tel:+917358996250" style="color: black">
                +91 7358996250</a>&nbsp;|&nbsp;<a href="tel:+919363081785" style="color: black">
                +91 9363081785</a>
            </li>
          </ul>
        </div>
      ...
      <div class="header-lower">
        ...
        <div class="main-box">
          ...
          <div class="nav-outer">
            ...
            <div class="outer-box">
              <a href="https://api.whatsapp.com/send/?phone=%2B917358996250&text=Hi Jose Edsion,  I need want your services, could you kindly share your pricing list with me?" target="_blank" class="theme-btn btn-style-two hvr-light"><span class="btn-title">Chat with us</span></a>
      ...
      <div class="mobile-menu">
        ...
        <nav class="menu-box">
          <div class="upper-box">
            <div class="nav-logo">
              <a href="index.html.htm"><img src="images/logo-2.png" alt="" title="Fesho" /></a>
            </div>
          ...
          <ul class="contact-list-one">
            <li>
              ...
              <div class="contact-info-box">
                ...
                <a href="tel:+917358996250">+91 7358996250</a>
              </div>
            </li>
            <li>
              <!-- Contact Info Box -->
              <div class="contact-info-box">
                ...
                <a href="mailto:info@jrtransport.com">info@jrtransport.com</a>
              </div>
            </li>
            <li>
              <!-- Contact Info Box -->
      ...
      <div class="sticky-header">
        <div class="auto-container">
          <div class="inner-container">
            <!--Logo-->
            <div class="logo">
              <a href="index.html.htm" title=""><img src="images/logo.png" alt="" title="" /></a>
            </div>
          ...
          <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2 wow fadeInRight" data-wow-delay="600ms">
            <div class="inner-column">
              <div class="sec-title">
                ...
                <h2>Legit Transport Service</h2>
                <h4>
                  Embark on a Journey of Seamless Transportation with JR
                  Transport:
                </h4>
                <div class="text">
                  At JR Transport, we take pride in offering a comprehensive
                  range of transportation services tailored to meet your
                  specific requirements. Whether you need a hassle-free
                  airport transfer, prompt delivery of goods, or a comfortable
                  ride for your special event, we have got you covered. Our
                  dedicated team of experienced professionals and a fleet of
                  well-maintained vehicles enable us to provide you with
                  top-notch services that you can rely on. Whether you are an
                  individual looking for reliable transportation solutions or
                  a business seeking efficient logistics services, JR
                  Transport is here to cater to your needs. Contact us today
                  and let us simplify your transportation requirements.
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="auto-container">
        ...
        <div class="services-carousel owl-carousel owl-theme">
          ...
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/9.jpg" class="lightbox-image"><img src="images/service_imgs/9.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
          ...
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/1.jpg" class="lightbox-image"><img src="images/service_imgs/1.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">02 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">STEEL</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/2.jpg" class="lightbox-image"><img src="images/service_imgs/2.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">03 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">TILES</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/8.jpg" class="lightbox-image"><img src="images/service_imgs/8.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">04 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">M - SAND</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/7.jpg" class="lightbox-image"><img src="images/service_imgs/7.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">05 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">P - SAND</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/6.jpg" class="lightbox-image"><img src="images/service_imgs/6.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">06 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">JALLI</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="https://cdn2.hubspot.net/hubfs/8313510/What%20Is%20Gravel%20Used%20For.png" class="lightbox-image"><img src="https://cdn2.hubspot.net/hubfs/8313510/What%20Is%20Gravel%20Used%20For.png" style="height: 470px; width: 370px;object-fit: cover;" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">07 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">GRAVEL</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/3.jpg" class="lightbox-image"><img src="images/service_imgs/3.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">09 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">BRICKS</a>
                </h4>
              </div>
            </div>
          </div>
          <div class="service-block-two">
            <div class="inner-box">
              <div class="image-box">
                <i class="icon flaticon-truck-2"></i>
                <figure class="image">
                  <a href="images/service_imgs/4.jpg" class="lightbox-image"><img src="images/service_imgs/4.jpg" alt="" /></a>
                </figure>
              </div>
              <div class="content-box">
                <span class="sub-title">10 Service</span>
                <h4 class="title">
                  <a href="page-service-details.html.htm">FAVER BLOCKS</a>
                </h4>
              </div>
            </div>
          </div>
    ...
    <section class="why-choose-us-two">
      ...
      <div class="anim-icons">
        <div class="float-image wow zoomInLeft">
          <img src="images/resource/float-img-3.png" alt="" />
        </div>
      </div>
      ...
      <div class="auto-container">
        <div class="row">
          ...
          <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column wow fadeInLeft">
              <div class="sec-title light">
                ...
                <div class="text">
                  We simplify your transportation needs with seamless and
                  hassle-free solutions, providing ease at every step
                </div>
              </div>
          ...
          <!-- Image Column -->
          <div class="image-column col-lg-6 col-md-12 col-sm-12">
            <div class="image-box hide-desktop">
    ...
    <section id="contact" class="testimonial-section-two">
      ...
      <div class="anim-icons">
        ...
        <div class="icon float-image wow fadeInRight">
          <img src="images/resource/delivery-boy.png" alt="" />
        </div>
      </div>
              ...
              <div class="testimonial-carousel-two owl-carousel owl-theme default-dots">
                ...
                <div class="testimonial-block-two">
                  <div class="inner-box">
                    ...
                    <div class="text">
                      JR Transport made my relocation stress-free and
                      effortless. Their team was professional, prompt, and
                      handled my belongings with utmost care. I highly
                      recommend their services
                    </div>
                    <div class="info-box">
                      <!-- <div class="thumb"><img src="images/resource/testi-thumb-4.jpg" alt=""></div> -->
                      <h4 class="name">Selvi</h4>
                ...
                <div class="testimonial-block-two">
                  <div class="inner-box">
                    <i class="icon icon-quote"></i>
                    <div class="text">
                      I needed a reliable logistics partner for my business,
                      and JR Transport exceeded my expectations. They ensured
                      timely deliveries and provided excellent customer
                      support. I'm extremely satisfied.
                    </div>
                    <div class="info-box">
                      <h4 class="name">Sivaraman</h4>
                      <span class="designation">Customer</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="testimonial-block-two">
                  <div class="inner-box">
                    <i class="icon icon-quote"></i>
                    <div class="text">
                      JR Transport is my go-to choice for all my
                      transportation needs. Their team is efficient,
                      trustworthy, and always goes the extra mile to ensure my
                      goods reach their destination safely
                    </div>
                    <div class="info-box">
                      <h4 class="name">Nesamani</h4>
                      <span class="designation">Customer</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="contact-form">
                ...
                <form method="post" action="mailtest.php" id="contact-form">
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                      <button class="theme-btn btn-style-two hvr-light" type="submit" name="submit-form">
          ...
          <div class="row">
            ...
            <div class="contact-info-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
              <div class="inner-box">
                ...
                <div class="text">
                  VIP Nagar, Thiru Nagar, Tiruchirappalli - 620 004.
                </div>
              </div>
            </div>
            ...
            <div class="contact-info-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="300ms">
              <div class="inner-box">
                ...
                <div class="text">
                  <a href="mailto:info@jrtransport.com">info@jrtransport.com</a>
                  <a href="mailto:jrtransport@gmail.com">jrtransport@gmail.com</a>
                </div>
              </div>
            </div>
            ...
            <div class="contact-info-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="600ms">
              <div class="inner-box">
                ...
                <div class="text">Mon - Sat: 8 Am - 7 Pm Sunday: CLOSED</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="widgets-section">
        <div class="auto-container">
          <div class="row">
            ...
            <!--Footer Column-->
            <div class="footer-column col-xl-3 col-lg-3 col-md-6 col-sm-12 d-none">
          ...
          <div class="inner-container">
            <div class="copyright-text">
              <p>
                ...
                by
                <a href="https://zworktechnology.com/" target="_blank">Zworktechnology.com</a>
              </p>
            </div>
